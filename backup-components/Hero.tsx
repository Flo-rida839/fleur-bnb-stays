      ...
      <div className="relative container mx-auto px-4 h-full flex items-center">
        <div className="max-w-2xl">
          ...
          <h1 className="text-5xl md:text-7xl font-serif text-white mb-4 leading-tight">
            Experience{' '}
            <span className="font-cursive text-gold shimmer-text">
              Unforgettable
            </span>{' '}
            Stays
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              href="/units"
              className="group glass-effect text-teal-900 px-8 py-4 rounded-full text-lg font-semibold flex items-center justify-center space-x-2 hover:shadow-lg transition-all duration-300"
            >
